...
mse_df <- readRDS("../99_Stored_Data/schmid_hothorn_df_dev.rds")

pdf("../../06_Plots/Main_Simulation/schmid_hothorn_boxplot.pdf", width = 6, height=4)
...
ggsave(box, file = "../../06_Plots/Main_Simulation/schmid_hothorn_boxplot.pdf", width = 6, height = 3)
